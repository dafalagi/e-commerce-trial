...
return [
    ...
    */
    ...
    'digits_between' => 'Bidang :attribute harus memiliki digit antara :min dan :max.',
    ...
    'lte' => [
        ...
        'file' => 'Bidang :attribute harus kurang atau sama dengan :value kilobyte.',
        'numeric' => 'Bidang :attribute harus kurang atau sama dengan :value.',
        'string' => 'Bidang :attribute harus kurang atau sama dengan :value karakter.',
    ],
    ...
    'required_without_all' => 'Bidang :attribute wajib diisi ketika tidak ada satupun dari :values.',
    ...
    */
    ...
    'custom' => [
        'uuid' => [
            'exists' => 'UUID tidak ditemukan.',
        ],
        'id' => [
            'exists' => 'ID tidak ditemukan.',
        ],
        'default_data' => 'Ini adalah data default, Anda tidak diizinkan untuk melakukan perubahan. Atau, data ini telah dihapus.',
        'unique_data' => 'Bidang :attribute telah digunakan.',
    ],
